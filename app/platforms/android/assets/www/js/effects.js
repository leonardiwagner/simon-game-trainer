var ButtonsHandler = function(Media){
  var SHADOW_SIZE = 9;
  ...
  var buttons = {
    "green": {
      ...
      "soundClick":  new Media('/android_asset/www/sound/sound-green.wav')
    ...
    "yellow": {
      ...
      "soundClick":  new Media('/android_asset/www/sound/sound-yellow.wav')
    },
    "red": {
      "name": "red",
      ...
      "soundClick":  new Media('/android_asset/www/sound/sound-red.wav')
    },
    "blue": {
      "name": "blue",
      ...
      "soundClick": new Media('/android_asset/www/sound/sound-blue.wav')
    }
  };

  var renderButtons = function(){
    var soundClick =  new Media('/android_asset/www/sound/sound-click.wav');
  ...
  var playRandomWinSound = function(score){
    if(score % 2 === 0 && score > 0 ){
      ...
      var x = new Media("/android_asset/www/sound/win-sounds/" + randomNumber + ".wav");
      x.play();
    }
  };
